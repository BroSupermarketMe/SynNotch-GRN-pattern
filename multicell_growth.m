function [entropy, surround_surEGFP,surround_Gal4,cv_surEGFP,cv_Gal4,H_surEGFP,H_Gal4,isstable] = multicell_growth(cell_generation, para)
arguments
    cell_generation (1,1) double = 10
